...
def fetch_comment(id):
    ...
    for link in soup.find_all("div", class_="user-post user-post__card js_product-review"):
        ...
        opinion_id = Ceneo_reviews(opinion_id, user_name, reccomendation, stars, content, advantages, disadvantages, helpful, helpful_not, publish_date, purchase_date)
        opinion_id.print_atributes()
        

if __name__ == "__main__":
    fetch_comment("97574473")